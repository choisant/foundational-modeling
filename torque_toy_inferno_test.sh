...
apptainer run apptainer/updated_env.sif toy_experiment/inferno/inferno_test.R ${nlist[${PBS_ARRAYID}-1]} 20 5 800 toy_experiment/inferno/metadata_r_a_x.csv toy_experiment/data/train_n_5000_kr9_kb3_s1_vary_a1_False.csv toy_experiment/data/val_n_5000_kr9_kb3_s1_vary_a1_False.csv
apptainer run apptainer/updated_env.sif toy_experiment/inferno/inferno_test.R ${nlist[${PBS_ARRAYID}-1]} 20 5 800 toy_experiment/inferno/metadata_r_a_x.csv toy_experiment/data/train_n_5000_kr9_kb3_s1_vary_a1_False.csv toy_experiment/data/x1_x2_grid.csv