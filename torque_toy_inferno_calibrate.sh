...
#apptainer run apptainer/updated_env.sif toy_experiment/inferno/inferno_calibrate.R 250 20 10 1200 toy_experiment/inferno/metadata_DNN.csv toy_experiment/DNN/predictions/val_n_5000_kr7_kg3_s1_vary_a1_False_predicted_SequentialNet_ndata-${nlist[${PBS_ARRAYID}-1]}.csv toy_experiment/data/x1_x2_grid.csv
#apptainer run apptainer/updated_env.sif toy_experiment/inferno/inferno_test_calibrate.R 250 20 10 1200 toy_experiment/inferno/metadata_DNN.csv toy_experiment/DNN/predictions/val_n_5000_kr7_kg3_s1_vary_a1_False_predicted_SequentialNet_ndata-${nlist[${PBS_ARRAYID}-1]}.csv toy_experiment/DNN/predictions/val_n_5000_kr7_kg3_s1_vary_a1_False_predicted_SequentialNet_ndata-${nlist[${PBS_ARRAYID}-1]}.csv
