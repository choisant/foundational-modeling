...
python analytical.py -f ${testfile} -s "jobarrays" --job_nr ${PBS_ARRAYID} --i_start $start --i_stop $stop --n_x_mc ${nX_MC} --n_r1_mc ${nr1_MC} --R2 ${R2} --R1_min ${R1_min} --kr ${k_red} --kb ${k_blue}
